		...
		<ul>
            ...
            <li>
				...
				<ul class="sub_menu" style="display: block;">
					<li><a href="{{url('admin/nav')}}" target="main"><i class="fa fa-fw fa-navicon"></i>自定義導覽列</a></li>
                    <li><a href="{{url('admin/config')}}" target="main"><i class="fa fa-fw fa-cubes"></i>網站配置</a></li>
