...
@section('content')
    ...
    <div class="crumb_warp">
        ...
        <i class="fa fa-home"></i> <a href="{{ url('admin/info') }}">首页</a> &raquo; 自定義導覽列
    </div>
    <!--面包屑导航 结束-->
        ...
        <div class="result_wrap">
            <div class="result_content">
                <table class="list_tab">
                    ...
                    <tr>
                        <td class="tc">
                            <input type="text" onchange="changeOrder(this,'{{ $data->nav_id }}')" value="{{ $data->nav_order }}">
                        </td>
                        <td class="tc">{{ $data->nav_id }}</td>
                        <td>
                            <a href="#">{{ $data->nav_name }}</a>
                        </td>
                        <td>{{ $data->nav_alias }}</td>
                        <td>{{ $data->nav_url }}</td>
                        <td>
                            <a href="{{ url('admin/nav/'.$data->nav_id.'/edit') }}">修改</a>
                            <a href="javascript:delLink({{$data->nav_id}})" onclick="">删除</a>
